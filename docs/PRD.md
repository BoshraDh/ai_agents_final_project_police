...
scent) and Stage 5 (cloud exposure + tunneling) complete: FR-1, FR-2, FR-3 (geometric check
...
`docs/PRD_language_scent.md` / `docs/PRD_cloud_tunnel.md` for stage-specific detail and
